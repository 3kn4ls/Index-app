...
# Script de release automático con GitHub Actions + ArgoCD
...
if [ $? -eq 0 ]; then
    ...
    print_info "   GitHub Actions: https://github.com/3kn4ls/Index-app/actions"
    print_info "   ArgoCD: https://northr3nd.duckdns.org/argocd"
    echo ""
    print_info "🔍 Ver estado local:"
    print_info "   kubectl get pods -l app=index-app -w"
    echo ""
